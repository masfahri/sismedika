...
<!-- Mirrored from fox-landing-page.netlify.app/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Sep 2021 06:43:08 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('v2/images/favicon.png') }}">
    <!-- Bootstrap CSS -->
    <link href="{{ asset('v2/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Slick Slider -->
    <link href="{{ asset('v2/css/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('v2/css/slick-theme.css') }}" rel="stylesheet">

    <!-- AOS CSS -->
    <link href="{{ asset('v2/css/aos.css') }}" rel="stylesheet">

    <!-- Lity CSS -->
    <link href="{{ asset('v2/css/lity.min.css') }}" rel="stylesheet">

    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="{{ asset('v2/css/fontawesome-all.min.css') }}">

    <!-- linearicons CSS -->
    <link rel="stylesheet" href="{{ asset('v2/css/linearicons.css') }}">

    <!-- Our Min CSS -->
    <link href="{{ asset('v2/css/main.css') }}" rel="stylesheet">

    <!-- Themes * You can select your color from color-1 , color-2 , color-3 , color-4 , ..etc * -->
    <link id="themes_colors" href="{{ asset('v2/css/color-1.css') }}" rel="stylesheet">
...
<body data-spy="scroll" data-target="#main_menu" data-offset="70">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="foxapp_menu">
            <div class="container">
                <a class="navbar-brand" href="index-2.html">
                    <img src="{{ asset('v2/img/fox-logo.png') }}" class="img-fluid" alt="">
                </a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-left" data-aos-delay="200">
                        <img src="{{ asset('v2/images/mobile-1.png') }}" class="img-fluid d-block mx-auto" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="about" class="why-us padding-100 background-fullwidth background-fixed "
        style="background-image: url({{ asset('v2/images/gray-bg.jpg') }});">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center" data-aos="fade-right">
                    <img src="{{ asset('v2/images/mobile-2.png') }}" class="img-fluid" alt="">
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <div class="features-circle">
                        ...
                        <img data-aos="fade-up" data-aos-delay="200" src="{{ asset('v2/images/mobile-3.png') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 offset-md-3" data-aos="fade-up">
                    <div class="video" style="background-image: url('{{ asset('v2/img/people.jpg') }}')">
                        <img src="{{ asset('v2/images/mobile-4-4.png') }}" class="img-fluid d-block mx-auto" alt="">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="screenshots-slider" data-aos="fade-up">
                        ...
                        <div class="item text-center">
                            <img src="{{ asset('v2/img/mobile-5.png') }}" class="img-fluid d-block mx-auto" alt="">
                        </div>
                        <div class="item text-center">
                            <img src="{{ asset('v2/img/mobile-5.png') }}" class="img-fluid d-block mx-auto" alt="">
                        </div>
                    ...
                    <div class="testimonial-slider" data-aos="fade-up">
                        <div class="item">
                            ...
                            <div class="client-info d-flex align-items-center">
                                <figure>
                                    <img src="{{ asset('v2/images/client.jpg') }}" class="img-fluid" alt="">
                                </figure>
                                <div>
                                    <h3>Mohamed Kamel</h3>
                        ...
                        <div class="item">
                            ...
                            <div class="client-info d-flex align-items-center">
                                <figure>
                                    <img src="{{ asset('v2/img/client.jpg') }}" class="img-fluid" alt="">
                                </figure>
                                <div>
                                    <h3>Mohamed Kamel</h3>
                                    <h6>CEO - Company Name</h6>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="price-table text-center" data-aos="fade-right" data-aos-delay="400">
                        <div class="top background-fullwidth" style="background-image: url(asset{{ ('v2/images/gray-bg.jpg') }});">
                            <h4>Personal</h4>
                            <h3>
                                <span>$</span>30
                            </h3>
                ...
                <div class="col-12">
                    <div class="team-slider" data-aos="fade-up">
                        <div class="item person text-center">
                            <img src="{{ asset('v2/images/team-1.jpg') }}" class="img-fluid d-block mx-auto" alt="">
                            <div class="space-20"></div>
                            <h3>Emilia Noah</h3>
                            <div class="space-20"></div>
                        ...
                        <div class="item person text-center">
                            <img src="{{ asset('v2/images/team-2.jpg') }}" class="img-fluid d-block mx-auto" alt="">
                            <div class="space-20"></div>
                            <h3>Harry Henry</h3>
                            <div class="space-20"></div>
                            <h5>Front-End Developer</h5>
                        ...
                        <div class="item person text-center">
                            <img src="{{ asset('v2/images/team-3.jpg') }}" class="img-fluid d-block mx-auto" alt="">
                            <div class="space-20"></div>
                            <h3>Poppy Reuben</h3>
                            <div class="space-20"></div>
                            <h5>Front-End Developer</h5>
                        ...
                        <div class="item person text-center">
                            <img src="{{ asset('v2/images/team-4.jpg') }}" class="img-fluid d-block mx-auto" alt="">
                            <div class="space-20"></div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-12" data-aos="fade-left" data-aos-delay="400">
                    <img src="{{ asset('v2/images/mobile-1.png') }}" class="img-fluid b-block mx-auto" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="logos-slider">
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-1.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-2.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-3.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-4.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-5.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-6.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('v2/images/logo-1.png') }}" class="img-fluid mx-auto b-block" alt="">
                        </div>
                        ...
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-md-6 col-12">
                                    <img src="{{ asset('v2/images/news-1.jpg') }}" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-6 col-12">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12" data-aos="fade-left" data-aos-delay="400">
                    <img src="{{ asset('v2/images/mobile-6.png') }}" class="img-fluid d-block mx-auto" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="padding-100 pb-0">
        ...
        <div class="space-50"></div>
        <div class="copyright" style="backround-color: 00CDCD">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4">
    ...
    <script src="{{ asset('v2/js/jquery-3.3.1.min.js') }}"></script>
    ...
    <!-- Slick Slider JS -->
    <script src="{{ asset('v2/js/slick.min.js') }}"></script>

    <!-- Counterup JS -->
    <script src="{{ asset('v2/js/waypoints.min.js') }}"></script>
    <script src="{{ asset('v2/js/jquery.counterup.js') }}"></script>

    <!-- AOS JS -->
    <script src="{{ asset('v2/js/aos.js') }}"></script>

    <!-- lity JS -->
    <script src="{{ asset('v2/js/lity.min.js') }}"></script>
