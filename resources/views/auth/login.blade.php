...
<body>
                ...
                <div>
                    <div class="forny-form">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mt-10">
                                Don't have an account? <a href="08_register.html">Register here</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script src="{{ asset('v2/js/demo.js') }}"></script>
</body>
